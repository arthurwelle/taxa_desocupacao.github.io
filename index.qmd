...
# cria gráfico ::ggplot
g <- ggplot2::ggplot(d)  +
          geom_line(aes(x =date, y =Desocupados, color = "Desocupados"), linewidth = 1.5) +
          geom_line(aes(x =date, y =Subocupados, color = "Subocupados"), linewidth = 1.5) +
          geom_line(aes(x =date, y =Desalentados, color = "Desalentados"), linewidth = 1.5) +
          geom_line(aes(x =date, y =ProcurouNaoAssumiria, color = "Força de Trabalho potencial (exceto desalento)"), linewidth = 1.5) +
          labs(x = element_blank(), y = "Milhões de pessoas",

...
Veja código no site <a href = "https://github.com/arthurwelle/taxa_desocupacao.github.io">github</a>.
...
Download dos `r embed_data(d, filename = "Dados.csv", label = "dados")`.
...
Download dos `r embed_data(d1, filename = "Dados.csv", label = "dados")`.
...
Download dos `r embed_data(d4, filename = "Dados.csv", label = "dados")`.
...
Download dos `r embed_data(d2, filename = "Dados.csv", label = "dados")`.
...
Download dos `r embed_data(d3, filename = "Dados.csv", label = "dados")`.
